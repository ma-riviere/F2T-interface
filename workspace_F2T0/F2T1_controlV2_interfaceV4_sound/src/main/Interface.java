                ...
                for(int i=0;i<received.length; i++){
                	...
                	if ((received[i] & 0xff)==255){
                		...
                		if (message_type==1){
                			...
                			main.jx.add(movementX);
                			main.jy.add(movementY);
                			if (main.jx.size()>5000){
                				main.jx.remove(0);
                				main.jy.remove(0);
                			}
            				...
            				if (main.dx<0.05 && main.dx>-0.05) main.dx=0;
            				if (main.dy<0.05 && main.dy>-0.05) main.dy=0;
            				
            				if (main.dx>0) main.dx-=0.05;
            				if (main.dx<0) main.dx+=0.05;
            				if (main.dy>0) main.dy-=0.05;
            				if (main.dy<0) main.dy+=0.05;

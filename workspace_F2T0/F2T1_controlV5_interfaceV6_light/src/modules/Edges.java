...
/**
 * Edge and height module
 * @author simon gay
 */

public class Edges extends Module{

	public static float SCALE=5000;
	...
	public void compute(){
					...
					if ((int)(virtual.px+i2+coeff*main.jx)>-350 && (int)(virtual.px+i2+coeff*main.jx)<350 && (int)(virtual.py+j2+coeff*main.jy)>-350 && (int)(virtual.py+j2+coeff*main.jy)<350){
						if (/*height2>height1 
								&&*/ (   main.currentAge.image.gradient[350+(int)(virtual.px+coeff*main.jx+i2)][350+(int)(virtual.py+coeff*main.jy+j2)][0]!=0 
								      || main.currentAge.image.gradient[350+(int)(virtual.px+coeff*main.jx+i2)][350+(int)(virtual.py+coeff*main.jy+j2)][1]!=0)){
							
							d2=1/((float)i2*(float)i2+(float)j2*(float)j2);
							
							if (i2*main.currentAge.image.gradient[350+(int)(virtual.px+coeff*main.jx+i2)][350+(int)(virtual.py+coeff*main.jy+j2)][0]>=0)
								gradX+=main.currentAge.image.gradient[350+(int)(virtual.px+coeff*main.jx+i2)][350+(int)(virtual.py+coeff*main.jy+j2)][0]*d2;
							
							if (j2*main.currentAge.image.gradient[350+(int)(virtual.px+coeff*main.jx+i2)][350+(int)(virtual.py+coeff*main.jy+j2)][1]>=0)
								gradY+=main.currentAge.image.gradient[350+(int)(virtual.px+coeff*main.jx+i2)][350+(int)(virtual.py+coeff*main.jy+j2)][1]*d2;
							sum+=d2;
							count++;
						}
					}
		...
		if (count>4){
			...
			offsetX=-gradientX*SCALE;
			offsetY=-gradientY*SCALE;

	...
	public void paintComponent(Graphics g){
		...
		for (int i=0;i<25;i++){
			for (int j=0;j<25;j++){
				...
				float pixel=main.edges.heighMap[i][j];
		...
		float val1=((float)(main.flow.getValue(0)-125)/127)*100;
		float val2=((float)(main.flow.getValue(1)-125)/127)*100;
		msg="(";
		if (val1>=0){
			if (val1==100) msg+=" 100";
		...
		val1=((float)(main.rail.getValue(0)-125)/127)*100;
		val2=((float)(main.rail.getValue(1)-125)/127)*100;

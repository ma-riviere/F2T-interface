...
public class DisplayAttractorEditPanel  extends JPanel implements ActionListener, MouseListener, MouseMotionListener, KeyListener{
	...
	public void paintComponent(Graphics g){
		...
		g.drawString("Load attractors", 720, 488);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==remove){
			...
			if (selected_point>0 && selected_point<main.script.ageList.get(main.script.currentAge).attractorList.size()){
				int x1=(main.script.ageList.get(main.script.currentAge).attractorList.get(selected_point).x 
					  + main.script.ageList.get(main.script.currentAge).attractorList.get(selected_point-1).x )/2;
				int y1=(main.script.ageList.get(main.script.currentAge).attractorList.get(selected_point).y 
					  + main.script.ageList.get(main.script.currentAge).attractorList.get(selected_point-1).y )/2;
				
				main.script.ageList.get(main.script.currentAge).attractorList.add(selected_point, new Attractor(x1, y1,main.attractor_strength, main.attractor_distance, main.attractor_type));
				pushBuffer();
			}
		}

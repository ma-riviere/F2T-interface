...
public class Target {
	...
	public Target(float x, float y, int speed, int control){
		this.x=x;
		this.y=y;
		this.speed=speed;
	...
	public Target(float x, float y, int speed, int control, float p1x, float p1y){
		this.x=x;
		this.y=y;
		this.speed=speed;
		this.control=control;
	...
	public Target duplicate(){
		return new Target(x, y, speed, control, p1x, p1y);
	}
}

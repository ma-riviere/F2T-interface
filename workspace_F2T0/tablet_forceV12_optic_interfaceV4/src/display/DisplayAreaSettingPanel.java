 ...
 */
public class DisplayAreaSettingPanel extends JPanel implements MouseListener, ActionListener{
	...
	public DisplayAreaSettingPanel(Main m, DisplayFrame f, KeyboardListener k){
		main=m;
		frame=f;
		...
		associationScroll.setBounds(10,130, 250, 200);
		...
		association_down.setBounds(270, 295, 90, 30);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==association_add){
			...
			if (!found){
				...
				System.out.println(main.currentAge.ages.size());

...
public class DisplayFilePanel extends JPanel implements ActionListener{
	...
	public DisplayFilePanel(Main m, KeyboardListener k){
		...
		list_association.setBounds(70,265, 170, 30);
		...
		association.setBounds(265, 265, 80, 30);
	...
	public void paintComponent(Graphics g){
		...
		g.drawRect(0, 170, 375, 130);
		g.drawString("Preset", 10, 195);
		g.drawString("Path", 10, 225);
		g.drawString("Sources", 10, 255);
		g.drawString("Assoc.", 10, 285);
		
		g.drawRect(0, 310, 375, 40);
		g.drawString("Script", 10, 335);

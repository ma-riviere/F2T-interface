...
/**
 * An Age is an independent environment with a story composed of a sequence of periods
 * @author simon gay
 */
...
public class Age {
	...
	public Areas areas;
	public BezierCurvePath targetSequence;
	...
	public Age(Main m, String n){
		...
		areas=new Areas();
		targetSequence=new BezierCurvePath();

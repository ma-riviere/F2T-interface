...
/**
 * sound source environment edition panel
 * @author simon gay
 */
...
public class DisplaySourceSettingPanel extends JPanel  implements ActionListener, MouseListener, KeyListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==remLast){
			main.script.ageList.get(main.script.currentAge).sourceList.get(main.script.ageList.get(main.script.currentAge).sourceList.size()-1).close();
			main.script.ageList.get(main.script.currentAge).sourceList.remove(main.script.ageList.get(main.script.currentAge).sourceList.size()-1);
		}
		if (e.getSource()==clearSources){
			for (int i=0;i<main.script.ageList.get(main.script.currentAge).sourceList.size();i++) main.script.ageList.get(main.script.currentAge).sourceList.get(i).close();
			main.script.ageList.get(main.script.currentAge).sourceList.clear();
		}
